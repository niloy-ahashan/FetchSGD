...
# ---------------------------------------------------------------
# MELD with **SketchFusionB** (Fixed Count Sketch + MLP Head)
#
# Fixed random Count Sketch hash functions map each modality's
# features into a shared table (differentiable scatter_add).
# MLP head decodes the fused sketch.
#
