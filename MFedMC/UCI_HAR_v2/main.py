...
def main():
    ...
    global_modality_encoders = [
        VectorMLP(args.acc_dim, k, args.feat_dim, args.mm_dropout,
                  use_refiner=args.use_refiner),
        VectorMLP(args.gyro_dim, k, args.feat_dim, args.mm_dropout,
                  use_refiner=args.use_refiner),
    ]
    ...
    file_name = os.path.join(
        results_dir,
        f"MFedMC_UCI_HAR_v2_mm_{args.partition}_feat{args.feat_dim}_{ref_str}_"
