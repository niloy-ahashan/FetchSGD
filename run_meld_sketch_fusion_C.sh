...
# ---------------------------------------------------------------
# MELD with **SketchFusionC** (Tensor Sketch Fusion)
#
# Two independent Count Sketches (one per modality) approximate
# the outer product via FFT convolution, capturing multiplicative
